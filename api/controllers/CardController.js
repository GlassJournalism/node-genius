...
AWS.config.update({accessKeyId: 'AKIAJ6C5BRYXWVLFBWVQ', secretAccessKey: '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', region: 'us-west-1'});
...
function cacheCard(baseUrl, cardId) {
    ...
    webshot(baseUrl + '/card/preview/' + cardId, options, function (err, renderStream) {
        AWS.config.update({accessKeyId: 'AKIAJ6C5BRYXWVLFBWVQ', secretAccessKey: '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', region: 'us-west-2'});
